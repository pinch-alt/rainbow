...
*   **Speed-Triggered Spawn Reduction:** At speed **320+**, the base spawn interval is increased to **1.35**. Between 290 and 320, it is **1.3**. Below 290, it remains at **0.875**.
...
*   **Time-Based Challenge:** Starting from the moment speed hits **340**, a timer begins. Every **30 seconds** elapsed after this point, the spawn interval decreases by **0.05**, creating a progressive challenge even at the speed plateau.
